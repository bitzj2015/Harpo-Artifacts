...
with open("../DATA/rl_result/attacker_base_persona_bids_Intent_0_0.1_aol.json", "r") as json_file:
    data = json.load(json_file)
for item in data[start:end]:
    for key in item.keys():
        base_url_seq["{}_aol_base".format(key)] = item[key]

with open("../DATA/rl_result/attacker_persona_bids_Intent_0_0.1_aol.json", "r") as json_file:
    data = json.load(json_file)
for item in data[start:end]:
    for key in item.keys():
        base_url_seq["{}_aol_bid".format(key)] = item[key]

with open("../DATA/rl_result/attacker_persona_segs_Intent_0_0.1_M1_aol.json", "r") as json_file:
    data = json.load(json_file)
for item in data[start:end]:
    for key in item.keys():
        base_url_seq["{}_aol_oracle_M1".format(key)] = item[key]

with open("../DATA/rl_result/attacker_persona_segs_Intent_0_0.1_M2_aol.json", "r") as json_file:
    data = json.load(json_file)
for item in data[start:end]:
    for key in item.keys():
        base_url_seq["{}_aol_oracle_M2".format(key)] = item[key]
print(base_url_seq)
if args.recollect == 0:
    count = 0
    batch_url_seq = []
